...
if GetLocale() == "esES" then
    ...
    L["Hide minimap icon tooltip"] = "Oculta el icono del minimapa para este addon. Aún puedes acceder a la configuración escribiendo /gnd o usando el compartimento de addons.";
end